            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    @foreach( $menu as $key=>$val)
                        <li>
                            <a href="#"><i class="fa {{$val['ad_icon']}}"></i> <span
                                        class="nav-label">{{$val['ad_name']}}</span><span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                @foreach( $val['data'] as $v)
                                    <li><a class="J_menuItem" href="{{$v['ad_url']}}">{{$v['ad_name']}}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="welcome" frameborder="0"
                        data-id="" seamless style="background:#fff;"></iframe>
            </div>
            <div class="footer">
                <div class="pull-right">
                    <strong>本系统由<i style="color:#f60">李沈阳</i> 开发...欢迎交流 -------
                    </strong>
                </div>
            </div>
        </div>
